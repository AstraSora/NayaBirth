    ...
    <div className="min-h-screen bg-gradient-warm">
      ...
      <div className="max-w-lg mx-auto px-4 pt-12 pb-8">
        <div className="text-center mb-8">
          ...
          <div className="mt-6 inline-flex items-center gap-2 px-4 py-2 bg-surface/70 rounded-full shadow-sm">
            <span className="text-xs text-foreground-muted font-medium">In partnership with</span>
            <img
              src={UCIHealthLogo}
              alt="UCI Health"
              className="h-5"
      ...
      {/* Footer */}
      <footer className="max-w-lg mx-auto px-4 pb-8 text-center text-sm text-foreground-muted">
        <p>
